      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div data-testid="footer-contact">
            ...
            {/* Redes Sociais */}
            <div className="mt-4">
              <h6 className="font-semibold mb-3 text-white">Redes Sociais</h6>
              <div className="space-y-2">
                <a 
                  href="https://www.facebook.com/jesse.j.sales/" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="flex items-center text-neutral-400 hover:text-white transition-colors duration-300 group"
                  data-testid="link-facebook"
                >
                  <div className="w-8 h-8 bg-neutral-800 hover:bg-blue-600 rounded-full flex items-center justify-center transition-colors duration-300 mr-3 group-hover:bg-blue-600">
                    <Facebook className="group-hover:text-white transition-colors duration-300" size={16} />
                  </div>
                  <span className="group-hover:text-white transition-colors duration-300">Facebook</span>
                </a>
                <a 
                ...
                >
                  <div className="w-8 h-8 bg-neutral-800 hover:bg-gradient-to-br hover:from-purple-500 hover:to-pink-500 rounded-full flex items-center justify-center transition-all duration-300 mr-3">
                    <Instagram className="group-hover:text-white transition-colors duration-300" size={16} />
                  </div>
                  <span className="group-hover:text-white transition-colors duration-300">Instagram</span>
                </a>
              </div>
            </div>
          </div>
