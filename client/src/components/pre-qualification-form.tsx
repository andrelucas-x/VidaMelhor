    ...
    <section id="contato" className="py-20 bg-neutral-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-neutral-500 text-[19px]" data-testid="subtitle-formulario">Preencha suas informações básicas e receba um atendimento personalizado via WhatsApp em minutos.</p>
        </div>
